          ...
          >
            <Tabs defaultValue="match" className="space-y-6">
              ...
              <TabsContent value="match" className="space-y-6">
                <Card className="rounded-2xl border border-border">
                  <CardHeader className="flex flex-row items-center justify-between pb-4">
                    ...
                    <CreateMatchDialog
                      ...
                      onSuccess={(id) => setSelectedMatchId(id)}
                    />
                  </CardHeader>
                ...
                {selectedMatch && players && matchMetrics && (
              ...
              <TabsContent value="practice" className="space-y-6">
                <Card className="rounded-2xl border border-border">
                  <CardHeader className="flex flex-row items-center justify-between pb-4">
                    ...
                    <CreateSessionDialog
                      defaultSportId={selectedSportId}
                      onSuccess={(id) => setSelectedSessionId(id)}
                    />
                  </CardHeader>
                  <CardContent className="space-y-3">
                    {sessionsLoading ? (
                ...
                {/* Practice Performance Form */}
                {selectedSession && players && practiceMetrics && (
